...
My project has `src/` (application code) and `tests/` (test files). I want stricter naming rules in `src/` but more lenient ones in `tests/`. Per-directory overrides let me do that:
