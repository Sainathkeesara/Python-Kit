...
- [py-spy modes comparison notebook](psy/notebooks/compare-py-spy-top-vs-record-vs-dump.ipynb) — Side-by-side top vs record/flamegraph vs dump on a shared CPU-bound target
...
- `psy/` — py-spy short-alias notebooks (profiling modes side-by-side)
