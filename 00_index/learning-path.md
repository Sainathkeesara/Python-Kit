...
- **Speedscope profiling workflow** — Record and export speedscope JSON from CPU-bound workloads: [speedscope script](../py-spy/scripts/tried-cpu-speedscope-record.py).
