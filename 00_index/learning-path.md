...
- **Security Best Practices** — Dependency scanning, secrets hygiene, input validation, least privilege. Primer: [Security Best Practices primer](../docs/concepts/security-best-practices/0000-primer-security-best-practices.md).
